...
Kein Kauf-, Stop- oder KO-Entscheid auf Basis eines veralteten oder fehlgeschlagenen Kursabrufs. Der Zeitpunkt und die Quelle müssen sichtbar sein.</div></div>
      ...
      <div class="card decision-panel decision-span-12">${sectionHeader('Installationsstand', 'Für den vollständigen Funktionsumfang')}<div class="table-shell-v25"><table><thead><tr><th>Baustein</th><th>Status</th><th>Erforderlich</th></tr></thead><tbody><tr><td>GitHub Dashboard</td><td><span class="chip good">29.2 Hybrid</span></td><td>index.html, app.js, news.js, decision.js, analytics.js, service-worker.js, reset.html</td></tr><tr><td>Supabase Schema</td><td><span class="chip ${state.schemaReady?'good':'warn'}">${state.schemaReady?'erreichbar':'prüfen'}</span></td><td>version25-schema.sql</td></tr><tr><td>V29 Market-Intelligence-Schema</td><td><span class="chip neutral">separat prüfen</span></td><td>version29-market-intelligence-schema.sql</td></tr><tr><td>V29.2 Hybrid-Schema</td><td><span class="chip neutral">zwingend</span></td><td>version29-2-hybrid-schema.sql</td></tr><tr><td>V28 Analytics-Schema</td><td><span class="chip neutral">separat prüfen</span></td><td>version28-analytics-schema.sql</td></tr><tr><td>News- und Telegram-Functions</td><td><span class="chip good">im Paket</span></td><td>GitHub Action „Supabase Functions deployen“</td></tr><tr><td>Hintergrund-Automatik</td><td><span class="chip neutral">Cron prüfen</span></td><td>setup-v29-2-hybrid-cron.sql</td></tr></tbody></table></div></div></div>`;
