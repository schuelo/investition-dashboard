...
-- Automatischer Market-Intelligence-Sync und Telegram-News-Alarm
--
-- VOR DEM AUSFÜHREN:
...
begin
  ...
  if existing_id is null then
    perform vault.create_secret(
      ...
      'Investition Dashboard V29 News-Cron'
    );
  else
...
select cron.schedule(
  ...
  select net.http_post(
    ...
    body := '{"force":true,"portfolio":true,"intelligence":true}'::jsonb,
