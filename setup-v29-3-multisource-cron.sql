-- Investition Dashboard V29.3 Multi-Source Hybrid
-- Stündlicher News-Market-Intelligence-Sync und Telegram-News-Alarm.
-- Das EODHD-Free-Kontingent wird innerhalb der Function separat begrenzt.
--
-- VOR DEM AUSFÜHREN:
...
begin
  ...
  if existing_id is null then
    perform vault.create_secret(
      ...
      'Investition Dashboard V29.3 Multi-Source News-Cron'
    );
  else
