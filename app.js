(() => {
  (() => {
    ...
    renderAll();
    initCloud();
    emitDashboardEvent("investition:ready", { version: "29.3", trades: trades.map((trade) => ({ ...trade })) });
    ...
    if ("serviceWorker" in navigator) {
      window.addEventListener("load", function() {
        navigator.serviceWorker.register("./service-worker.js?v=29.3").catch(function(err) {
