(() => {
  (() => {
    ...
    function saveLocal() {
      // Version 29.0 arbeitet ausschließlich in der Cloud. Persönliche Daten
    ...
    renderAll();
    initCloud();
    emitDashboardEvent("investition:ready", { version: "29.2", trades: trades.map((trade) => ({ ...trade })) });
    ...
    if ("serviceWorker" in navigator) {
      window.addEventListener("load", function() {
        navigator.serviceWorker.register("./service-worker.js?v=29.2").catch(function(err) {
