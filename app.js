(() => {
  (() => {
    ...
    function saveLocal() {
      // Version 28.1 arbeitet ausschließlich in der Cloud. Persönliche Daten
    ...
    renderAll();
    initCloud();
    emitDashboardEvent("investition:ready", { version: "28.1", trades: trades.map((trade) => ({ ...trade })) });
    ...
    if ("serviceWorker" in navigator) {
      window.addEventListener("load", function() {
        navigator.serviceWorker.register("./service-worker.js?v=28.1").catch(function(err) {
